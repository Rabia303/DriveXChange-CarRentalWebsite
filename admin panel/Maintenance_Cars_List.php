                        ...
                        <div class="container p0">
                            ...
                            <div class="row mb6 align-items-center">
                                <div class="col-md-6 mobile-bottom-fix">
                                    <h1 class="page-title mb2">Cars Under Maintenance</h1>
                                    <nav class="breadcrumb-nav" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Cars Under
                                                Maintenance</li>
                                        </ol>
                                    </nav>
                                </div>
                                            ...
                                            <table class="table qd-table mb6 align-middle">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge rounded-pill badge-soft text-bg-danger">Maintainance</span>
                                                        </td>
                                                        <td>
