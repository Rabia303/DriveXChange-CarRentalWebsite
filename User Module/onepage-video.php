...
?>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 mb-30">
                    <div class="content">
                        ...
                        </ul> <a href="about.php" class="button-1">Read More <span class="ti-arrow-top-right"></span></a>
                    </div>
                </div>
    ...
    <!-- Services 2 -->
    <section id="services" data-scroll-index="2" class="services2 section-padding">
        <div class="container">
            <div class="row">
    ...
    <!-- Cars 1 -->
    <section id="cars" data-scroll-index="3" class="cars1 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-30">
